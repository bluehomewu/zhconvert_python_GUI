...
class PreferencesTab:
    ...
    def __init__(self, tab, service_info):
        ...
        self.tab.grid_columnconfigure((0, 1, 2),
                                      weight=1,
                                      uniform="pref_group")
    ...
    def _create_general_column(self, parent, col):
        ...
        jp_strategy_values = [
            "protect", "protectOnlySameOrigin", "fix", "none"
        ]
        customtkinter.CTkLabel(body, text="一般日文的處理策略").pack(anchor="w",
                                                            pady=(5, 0))
        ...
        customtkinter.CTkLabel(api_server_frame,
                               text="API 伺服器").grid(row=0,
                                                    column=0,
                                                    padx=(0, 10))
        ...
        customtkinter.CTkLabel(api_key_frame, text="API 金鑰").grid(row=0,
                                                                  column=0,
                                                                  padx=(0, 10))
    ...
    def _create_tidy_column(self, parent, col):
        ...
        customtkinter.CTkLabel(tab_frame,
                               text="將 Tab 轉換為數個空格").grid(row=0,
                                                          column=0,
                                                          padx=(0, 10))
    ...
    def _create_diff_column(self, parent, col):
        ...
        diff_options = {
            ...
            "diffSmartForLocalization": "使用智慧型本地化差異比較",
        ...
        customtkinter.CTkLabel(option_frame, text="前後文行數").grid(row=0,
                                                                column=0,
                                                                padx=(0, 10))
        ...
        customtkinter.CTkLabel(option_frame, text="輸出樣板").grid(row=1,
                                                               column=0,
                                                               padx=(0, 10),
                                                               pady=5)
        self.diff_template_menu = customtkinter.CTkOptionMenu(
            option_frame,
            values=list(self.service_info['diffTemplates'].keys()))
        ...
        self.tedious_keywords_textbox = customtkinter.CTkTextbox(body,
                                                                 height=80)
    ...
    def _add_checkbox(self, parent, key, text):
        ...
        cb = customtkinter.CTkCheckBox(parent,
                                       text=text,
                                       variable=var,
                                       onvalue="on",
                                       offvalue="off")
